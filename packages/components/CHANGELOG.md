...
## 1.1.9 remove-top-level-await-2nd (#25) (2023-06-16T13:21:14Z)
* version: 1.1.9
* branch: tags/@toplo/api@1.2.0
* subject: 1.1.9 remove-top-level-await-2nd (#25)
* message: remove-top-level-await-2nd (#25)
* author: Petar Zarkov
* email: 46219231+petarzarkov@users.noreply.github.com
* date: 2023-06-16T13:21:14Z
* commit: [527a5d358d879f8c63d874979ee435e29f05b440](https://github.com/petarzarkov/toplo/commit/527a5d358d879f8c63d874979ee435e29f05b440)

## 1.2.0 update-deps-and-structure (#23)

* update-deps-and-structure
...
* revert eslint we are not yet ready for esm (2023-06-16T13:10:36Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 update-deps-and-structure (#23)
...
* revert eslint we are not yet ready for esm
* message: update-deps-and-structure (#23)
...
* author: Petar Zarkov
* email: 46219231+petarzarkov@users.noreply.github.com
* date: 2023-06-16T13:10:36Z
* commit: [2e3d9a5056df409e7e474052cbf0d447261c69a1](https://github.com/petarzarkov/toplo/commit/2e3d9a5056df409e7e474052cbf0d447261c69a1)

## 1.2.0 update-lock (2022-11-22T06:23:32Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 update-lock
* message: update-lock
* author: Petar Zarkov
...
## 1.2.0 some-component-adjustments (2022-11-22T05:56:18Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 some-component-adjustments
...
## 1.2.0 revert-to-theme-name-provider (2022-11-21T13:48:53Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 revert-to-theme-name-provider
...
## 1.2.0 configurable-footer (2022-11-21T13:34:28Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 configurable-footer
...
## 1.2.0 add-not-found-component-export-it (2022-11-21T13:15:48Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 add-not-found-component-export-it
...
## 1.2.0 add-not-found-component (2022-11-21T13:09:12Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 add-not-found-component
...
## 1.2.0 add exports require (2022-10-24T15:06:21Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 add exports require
...
## 1.2.0 add test pkg (2022-10-23T13:28:15Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 add test pkg
...
## 1.2.0 publish-with-pnpm (2022-10-21T13:24:39Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 publish-with-pnpm
...
## 1.2.0 log getCommitPkgV err (2022-10-19T06:16:07Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 log getCommitPkgV err
...
## 1.2.0 add-stuff-to-componenents (2022-10-19T06:15:25Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 add-stuff-to-componenents
...
## 1.2.0 fix/changelog-latest (2022-10-18T14:22:26Z)
* version: 1.2.0
* branch: main
* subject: 1.2.0 fix/changelog-latest
